...
- Uses Gemini 1.5 Flash model for intelligent responses
...
1. **API Key errors**
   ...
   - Check if you've set the environment variable properly
   - Ensure billing is enabled for Gemini API
   - Try restarting the application after setting the key
